      ...
      <div className="contact__container">
        ...
        <div className="contact__card">
          <form
            ...
            action="https://formspree.io/f/xljrjyea"  
            method="POST"
            onKeyDownCapture={(e) => {
              const isField =
      ...
      <div className="contact__footer">
        <div className="contact__footerInner">
          <div className="contact__copyright">
            © {new Date().getFullYear()} Udaykx. All rights reserved.
          </div>

          <div className="contact__links">
            <a
              href="https://www.linkedin.com/in/udaykx/"
              target="_blank"
            ...
            <a
              href="https://www.youtube.com/@udaylens"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="YouTube"
            >
            ...
            <a
              href="https://www.instagram.com/udaykx"
              target="_blank"
              rel="noopener noreferrer"
